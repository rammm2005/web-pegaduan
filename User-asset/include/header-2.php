  ...
  <nav>
    <div class="nav-container">
      ...
      <ul>
        ...
        if ($data != '') { ?>
          <li><a href="User-profile/profile.php?&id=<?= $_SESSION['nik'] ?>"> <i class="fa fa-user-secret"></i>
              <?= $data['nama'] ?>
            </a></li>
          <li><a href="User-asset/include/logout.php"><img src="User-asset/Asset/img/sign-out.png" alt="" width="30"></a>
          </li>
          <?php
        } else { ?>
