...
! function (e) {
    ...
    t = {
                ...
                i = a.resumableManager = {
                    ...
                    sendAjax: function (e, s, l) {
                        ...
                        if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                            if (s > r.maxRetries) return h(g.resumableMaxRetriesReached, {
                                n: r.maxRetries
                            }), void i.setProcessed("error");
                            var v, w, b, _, C, x, y = f.slice ? "slice" : f.mozSlice ? "mozSlice" : f.webkitSlice ? "webkitSlice" : "slice",
                                T = f[y](c * e, c * (e + 1));
                            v = new FormData, d = o.stack[u], a._setUploadData(v, {
                                ...
                                return a._isAborted() ? void h(g.resumableAborting) : (w = a._getOutData(v, t), i.setAjaxError(t, r, n), a._raise("filechunkajaxerror", [u, e, s, o, i, w]), i.pushAjax(e, s + 1), void h(g.resumableRetryError, {
                                    n: s - 1
                                }))
                            }, x = function () {
        ...
        _initTemplateDefaults: function () {
            var i, a, r, n, o, s, l, d, c, u, f, p, g, m, h, v, w, b, _, C, x, y, T, P, k, F, S, I, E, A, z, D, j, $, U, M, R, B, O, L, N, Z, H, W, V = this,
                q = function (e, i) {
        ...
        _initPreviewCache: function () {
            ...
            i.previewCache = {
                ...
                get: function (e, a) {
                    ...
                    return g && g.length ? (a = void 0 === a ? !0 : a, o = t.ifSet("type", p, i.initialPreviewFileType || "generic"), l = t.ifSet("filename", p, t.ifSet("caption", p)), d = t.ifSet("filetype", p, o), s = i.previewCache.footer(e, a, p && p.size || null), c = t.ifSet("frameClass", p), r = m ? v(o, g, l, d, s, u, c) : v("generic", g, l, d, s, u, c, o).setTokens({
                        content: f.content[e]
                    }), f.tags.length && f.tags[e] && (r = t.replaceTags(r, f.tags[e])), t.isEmpty(p) || t.isEmpty(p.frameAttr) || (n = t.createElement(r), n.find(".file-preview-initial").attr(p.frameAttr), r = n.html(), n.remove()), r) : ""
                },
                clean: function (e) {
        ...
        _setZoomContent: function (i, a) {
            var r, n, o, s, l, d, c, u, f, p, g, m, h = this,
                v = i.attr("id"),
                w = h._getZoom(v),
                b = h.$modal,
                ...
                y = i.data("zoom");
            y && (y = decodeURIComponent(y), m = w.html().replace(h.zoomPlaceholder, "").setTokens({
                zoomData: y
            }), w.html(m), i.data("zoom", ""), w.attr("data-zoom", y)), n = w.attr("data-template") || "generic", r = w.find(".kv-file-content"), o = r.length ? r.html() : "", p = i.data("caption") || h.msgZoomModalHeading, g = i.data("size") || "", u = i.data("description") || "", b.find(".kv-zoom-caption").attr("title", p).html(p), b.find(".kv-zoom-size").html(g), f = b.find(".kv-zoom-description").hide(), u && (h.showDescriptionClose && (u = h._getLayoutTemplate("descriptionClose").setTokens({
                closeIcon: h.previewZoomButtonIcons.close
            }) + "</button>" + u), f.show().html(u), h.showDescriptionClose && h._handler(b.find(".kv-desc-hide"), "click", function () {
        ...
        _uploadSingle: function (i, a, r, n) {
            var o, s, l, d, c, u, f, p, g, m, h, v, w, b = this,
                _ = b.fileManager,
                C = _.count(),
                x = new FormData,
                y = b._getThumbId(a),
            ...
            }, b._setFileData(x, k.file, S, a), b._setUploadData(x, {
                fileId: a
        ...
        _generatePreviewTemplate: function (i, a, r, n, o, s, l, d, c, u, f, p, g, m, h) {
            ...
            }, p = p || o.slice(o.lastIndexOf("-") + 1), x = y.fileActionSettings.showRotate && -1 !== e.inArray(S, y.rotatableFileExtensions), y.fileActionSettings.showZoom && (C = "kv-zoom-thumb", x && (C += " rotatable" + (U ? " hide-rotate" : "")), P = _(U ? "other" : i, a, !0, C, h)), P = "\n" + y._getLayoutTemplate("zoomCache").replace("{zoomContent}", P), "function" == typeof y.sanitizeZoomCache && (P = y.sanitizeZoomCache(P)), C = "kv-preview-thumb", x && (w = $ || y.hideThumbnailContent || !!y.previewFileIconSettings[S], C += " rotatable" + (w ? " hide-rotate" : "")), v = _($ ? "other" : i, a, !1, C, h), v.setTokens({
                zoomCache: P
            })
        },
        ...
        _getResizedImage: function (i, a, r, n) {
            var o, s, l, d, c, u, f, p, g, m, h = this,
                v = e(a.img)[0],
                w = v.naturalWidth,
                b = v.naturalHeight,
                _ = 1,
        ...
        _renderFileActions: function (e, t, i, a, r, n, o, s, l, d, c, u, f) {
            ...
            var g, m = l === !1 ? "" : ' data-url="' + l + '"',
                ...
                P = p.otherActionButtons.setTokens({
                    dataKey: b,
                    key: d
                }),
        ...
        readFiles: function (i) {
            ...
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                r.lock(!0);
                var x, y, T, P, k, F, S, I, E, A, z, D, j, $, U, M, R, B = i[w],
                    O = B && B.size || 0,
                    L = r._getSize(O, !0),
                    N = f.image,
                    Z = O / r.bytesToKB,
                ...
                if (R = function (e) {
                    ...
                    if (R(), g > 0)
                        for (P = 0; g > P; P++) I = p[P], E = r.msgFileTypes[I] || I, V += 0 === P ? E : ", " + E;
        ...
        cancel: function () {
            ...
            if (i.enableResumableUpload && o ? (o.cancel().done(function () {
                ...
                }), r.reset(), i._raise("fileuploadcancelled", [i.fileManager, r])) : (i.ajaxPool && i.ajaxPool.cancel(), i._raise("fileuploadcancelled", [i.fileManager])), i._initAjax(), s > 0)
