...
<div class="alert alert-light" role="alert">
	...
	<form method="POST">
		<div class="form-group">
			...
			<h6>Yakin Akan Menghapus Data Tanggapan <b><?php echo $data['id_tanggapan'] ?></b> ?</h6>
			<input type="hidden" name="id_tanggapan" value="<?php echo $id ?>" required class="form-control">
			<button type="submit" name="hapus" class="btn btn-danger"> <i class="fa fa-trash"></i> Hapus </button>
			<a href="dashboard.php?page=tanggapan" class="btn btn-warning"> <i class="fa fa-arrow-left"></i> Batal</a>
...
<?php
	if(isset ($_POST['hapus'])){ //proses hapus data tanggapan
			...
			echo '
				...
				swal({
				  ...
				  button:"Okey",
					...
					window.location="dashboard.php?page=tanggapan"; //menuju ke pageaman tanggapan
				</script>
			';
		}
	}
