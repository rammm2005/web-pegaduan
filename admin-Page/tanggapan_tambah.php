            ...
            <div class="card-body col-md-12">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="selectpicker form-control" id="exampleFormControlSelect1" name="id_petugas"  data-live-search="true" title="Select Petugas" data-hide-disabled="true">
                            ...
                            <?php
                                        ...
                                        {
                                        ?>
                            <option value="<?php echo $data['id_petugas'] ?>">  <?php echo $data['nama_petugas'] ?> | <?php echo $data['telp'] ?>
                            </option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                     ...
                     <select class="selectpicker form-control" id="number" name="id_pengaduan"  data-live-search="true" title="Select Isi Pengaduan" data-hide-disabled="true">
                            ...
                            <option value="<?php echo  $data['id_pengaduan'] ?>">
...
<?php
    if(isset ($_POST['simpan'])){ //proses simpan data tanggapan
	    $tgl_tanggapan = $_POST['tgl_tanggapan'];
        $tanggapan = $_POST['tanggapan'];
	    $id_petugas = $_POST['id_petugas'];
        $id_pengaduan = $_POST['id_pengaduan'];

        // var_dump($id_petugas , $id_pengaduan);
        // exit();
     ...
     if ($tgl_tanggapan == '' || $tanggapan == '' || $id_petugas == '' || $id_pengaduan == '') {
        ...
        // require 'koneksi.php';
	    $simpan = mysqli_query($koneksi, 'INSERT INTO tanggapan(tgl_tanggapan,tanggapan,id_petugas,id_pengaduan) VALUES ("'.$tgl_tanggapan.'","'.$tanggapan.'","'.$id_pengaduan.'","'.$id_petugas.'")');
